...
var tokenss = tokenizer('(if (< 10 5) (+ 1 1) (* 3 2))');
console.log("Input: " + '(if (< 10 5) (+ 1 1) (* 3 2))');
console.log(JSON.stringify(tokenss, null, 4));
...
var astt = parser(tokenss);
console.log("Ast: \n" + JSON.stringify(astt, null, 3));
